...
# bimage = pygame.image.load("8552481.webp")
# bimage = pygame.transform.scale(bimage,(S) )
# Colors
white = (255, 255, 255)
red = (255, 0, 0)
black = (144, 238, 144)
...
bimage = pygame.image.load("8552481.webp")
bimage = pygame.transform.scale(bimage,(SCREENWIDTH,SCREENHEIGHT) ).convert_alpha()
dimage = pygame.image.load("images.jpg")
dimage = pygame.transform.scale(dimage,(SCREENWIDTH,SCREENHEIGHT) ).convert_alpha()
# Creating Title
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    pygame.mixer.music.load('On.mp3.mp3')
...
def gameloop():
    ...
    velocity_x = 0
    velocity_y = 0
    apple_x = random.randint(0, SCREENWIDTH-20)  # It Will Create a Random Number
    apple_y = random.randint(0, SCREENHEIGHT-20)  # It Will Create a Random Number
    score = 0
    snk_list = []
    snk_length = 1
    ...
    while exit_game!=True:
        if game_over :
            ...
            gameWindow.blit(dimage,(0,0))
            show("Please Enter to Continue",red, 200,450)
